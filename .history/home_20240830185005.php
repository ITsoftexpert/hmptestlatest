...
<div class="ram_cat_list mt-4">
  ...
  <div class="ram_left_cat">
   ...
   <li> <a href="<?= $site_url; ?>/categories/programming-tech/Mobile-App-Development" class="left_cat_item">Mobile App
      Development</a>
   <li> <a href="<?= $site_url; ?>/categories/graphics-design/Art-Illustration" class="left_cat_item">Art & Illustration</a>
   <li> <a href="<?= $site_url; ?>/categories/programming-tech/Data-Science-ML" class="left_cat_item">Data Science & ML</a>
   <li> <a href="<?= $site_url; ?>/categories/programming-tech/Website-Platforms/Shopify" class="left_cat_item">Shopify
      Developer</a>
   <li> <a href="<?= $site_url; ?>/categories/programming-tech/Game-Development" class="left_cat_item">Game Development</a>
   ...
   <li> <a href="<?= $site_url; ?>/categories/graphics-design/Product-Gaming" class="left_cat_item">Product & Gaming</a>
   <li> <a href="<?= $site_url; ?>/categories/business/Financial-Services" class="left_cat_item">Financial Services</a>
 </ul>
    <!-- Repeat for other items -->
  </div>

  <div class="ram_right_cat">
   <li> <a href="<?= $site_url; ?>/categories/digital-marketing/Social/seo" class="left_cat_item">SEO</a>
