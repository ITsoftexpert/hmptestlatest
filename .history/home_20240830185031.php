...
<div class="ram_cat_list mt-4">
  ...
  <div class="ram_left_cat">
     <ul></ul>
   <li><a href="<?= $site_url; ?>/categories/programming-tech/AI-Development" class="left_cat_item">AI Development li

   <li><a href="<?= $site_url; ?>programming-tech/Website-Development/E-Commerce-Development"
      class="left_cat_item">E-Commerce Development li
   ...
   <li><a href="<?= $site_url; ?>/categories/video-animation/Editing-Post-Production/Video-Editing"
      class="left_cat_item">Video Editing li
   <li><a href="<?= $site_url; ?>/categories/programming-tech/Mobile-App-Development" class="left_cat_item">Mobile App
      Development li
   <li><a href="<?= $site_url; ?>/categories/graphics-design/Art-Illustration" class="left_cat_item">Art & Illustration li
   <li><a href="<?= $site_url; ?>/categories/programming-tech/Data-Science-ML" class="left_cat_item">Data Science & ML li
   <li><a href="<?= $site_url; ?>/categories/programming-tech/Website-Platforms/Shopify" class="left_cat_item">Shopify
      Developer li
   <li><a href="<?= $site_url; ?>/categories/programming-tech/Game-Development" class="left_cat_item">Game Development li
   <li><a href="<?= $site_url; ?>/categories/graphics-design/3D-Design" class="left_cat_item">3D Design li
   <li><a href="<?= $site_url; ?>/categories/writing-translation/Career-Writing/Resume-Writing"
      class="left_cat_item">Resume Writer li
   <li><a href="<?= $site_url; ?>/categories/graphics-design/Product-Gaming" class="left_cat_item">Product & Gaming li
   <li><a href="<?= $site_url; ?>/categories/business/Financial-Services" class="left_cat_item">Financial Services li
 </ul>
    <!-- Repeat for other items -->
  </div>

  <div class="ram_right_cat">
   <li><a href="<?= $site_url; ?>/categories/digital-marketing/Social/seo" class="left_cat_item">SEO li
    ...
    <a href="<?= $site_url; ?>/categories/digital-marketing/Social/Social-Media-Marketing" class="left_cat_item">Social
      Media Marketing li
    <a href="<?= $site_url; ?>/categories/writing-translation/Content-Writing" class="left_cat_item">Content Writer li
    ...
    <a href="<?= $site_url; ?>/categories/writing-translation/Content-Writing/Scriptwriting"
      class="left_cat_item">Scriptwriting li
    <a href="<?= $site_url; ?>/categories/programming-tech/Software-Development" class="left_cat_item">Software
      Development li
    <a href="<?= $site_url; ?>/categories/programming-tech/Data-Science-ML" class="left_cat_item">Data Science & ML li
    <a href="<?= $site_url; ?>/categories/music-audio/Sound-Design" class="left_cat_item">Sound Design li
    <a href="<?= $site_url; ?>/categories/personal-growth/fashion-amp-style" class="left_cat_item">Fashion & Style li
    <a href="<?= $site_url; ?>/categories/ai-services/ai-for-businesses" class="left_cat_item">AI for Businesses li
    <a href="<?= $site_url; ?>/categories/programming-tech/Game-Development" class="left_cat_item">Game Development li
    <a href="<?= $site_url; ?>/categories/programming-tech/AI-Development" class="left_cat_item">AI Development li
