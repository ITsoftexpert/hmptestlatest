...
<div class="ram_cat_list mt-4">
  ...
  <div class="ram_left_cat">
    ...
    <ul><a href="<?= $site_url; ?>/categories/programming-tech/AI-Development" class="left_cat_item">AI Development</a>
    </ul>
...
<li> <a href="<?= $site_url; ?>/categories/writing-translation/Content-Writing" class="left_cat_item">Content Writer</a>
  </div>li>
...
<li> <a href="<?= $site_url; ?>/categories/music-audio/Sound-Design" class="left_cat_item">Sound Design</a> </div>li>
<li> <a href="<?= $site_url; ?>/categories/personal-growth/fashion-amp-style" class="left_cat_item">Fashion & Style</a>
  </div>li>
<li> <a href="<?= $site_url; ?>/categories/ai-services/ai-for-businesses" class="left_cat_item">AI for Businesses</a>
  </div>li>
<li> <a href="<?= $site_url; ?>/categories/programming-tech/Game-Development" class="left_cat_item">Game Development</a>
  </div>li>
