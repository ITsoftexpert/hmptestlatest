...
" id="dummy-video-content-border">
  <div class="cards ">
    <div class="d-flex justify-content-between align-items-center pb-2 " id="top-propo-div-respon">
      <h5 class="my-0 textdarkheadingempowerTps">Discover our 222top sellers</h5>
...
<div class="ram_cat_list mt-4 pl-4 pr-3">
  ...
  <div class="ram_left_cat">
    ...
    <ul class="p-0">
      ...
      <li> <a href="<?= $site_url; ?>/categories/programming-tech/Mobile-App-Development" class="left_cat_item">Mobile
          App
          Development</a> </li>
      <li> <a href="<?= $site_url; ?>/categories/graphics-design/Art-Illustration" class="left_cat_item">Art &
          Illustration</a> </li>
      <li> <a href="<?= $site_url; ?>/categories/programming-tech/Data-Science-ML" class="left_cat_item">Data Science &
          ML</a> </li>
  ...
  <div class="ram_right_cat">
    ...
    <ul class="p-0">
      ...
      <li> <a href="<?= $site_url; ?>/categories/writing-translation/Content-Writing" class="left_cat_item">Content
          Writer</a> </li>
