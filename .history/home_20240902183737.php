...
" id="dummy-video-content-border">
  ...
  <div class="display_flex_position"><a class="btn theme-bg text-white" id="top-view-response"
      ...
      <div
        ...
        <h2 class="text-center ">Get top-tier talent, exceptional service, and quick results by hiring from our
          platform.</h2>
                  ...
                  <a href="<?= $site_url; ?>/proposals/<?= $seller_user_name; ?>/<?= $proposal_url; ?>"
                    ...
                    <div class="card-body">
                      <div class="d-flex">
                        ...
                        <div class="px-3 d-flex justify-content-between w-100 align-items-center">
                          <div class="">
                            <h5 class="card-title font-weight-bold mb-0"><?= $seller_user_name; ?>   <?= $proposal_id ?>
                            </h5>
                            <small class="text-secondary"><?= $seller_level; ?></small>
                          </div>
                          <div class="text-secondary">
      ...
      <div class="ram_cat_list mt-4">
        ...
        <div class="ram_left_cat">
          ...
          <ul>
            <li>
              <a href="<?= $site_url; ?>/categories/programming-tech/AI-Development" class="left_cat_item">AI
                Development</a>
            </li>
            ...
            <li> <a href="<?= $site_url; ?>categories/graphics-design/Logo-Brand-Identity/Logo-Design"
                class="left_cat_item">Logo
                Design</a> </li>
            ...
            <li> <a href="<?= $site_url; ?>/categories/programming-tech/Mobile-App-Development"
                class="left_cat_item">Mobile App
                Development</a> </li>
            <li> <a href="<?= $site_url; ?>/categories/graphics-design/Art-Illustration" class="left_cat_item">Art &
                Illustration</a> </li>
            <li> <a href="<?= $site_url; ?>/categories/programming-tech/Data-Science-ML" class="left_cat_item">Data
                Science & ML</a> </li>
            <li> <a href="<?= $site_url; ?>/categories/programming-tech/Website-Platforms/Shopify"
                class="left_cat_item">Shopify
                Developer</a> </li>
            <li> <a href="<?= $site_url; ?>/categories/programming-tech/Game-Development" class="left_cat_item">Game
                Development</a> </li>
            <li> <a href="<?= $site_url; ?>/categories/graphics-design/3D-Design" class="left_cat_item">3D Design</a>
            </li>
            <li> <a href="<?= $site_url; ?>/categories/writing-translation/Career-Writing/Resume-Writing"
                class="left_cat_item">Resume Writer</a> </li>
            <li> <a href="<?= $site_url; ?>/categories/graphics-design/Product-Gaming" class="left_cat_item">Product &
                Gaming</a> </li>
            <li> <a href="<?= $site_url; ?>/categories/business/Financial-Services" class="left_cat_item">Financial
                Services</a> </li>
          </ul>
        ...
        <div class="ram_right_cat">
          ...
          <ul>
            ...
            <li> <a href="<?= $site_url; ?>/categories/programming-tech/Website-Development"
                class="left_cat_item">Website
                Development</a> </li>
            <li> <a href="<?= $site_url; ?>/categories/digital-marketing/Social/Social-Media-Marketing"
                class="left_cat_item">Social
                Media Marketing</a> </li>
            <li> <a href="<?= $site_url; ?>/categories/writing-translation/Content-Writing"
                class="left_cat_item">Content Writer</a> </li>
            <li> <a href="<?= $site_url; ?>/categories/programming-tech/Software-Development"
                class="left_cat_item">Software
                Development</a> </li>
            ...
            <li> <a href="<?= $site_url; ?>/categories/programming-tech/Data-Science-ML" class="left_cat_item">Data
                Science & ML</a> </li>
            <li> <a href="<?= $site_url; ?>/categories/music-audio/Sound-Design" class="left_cat_item">Sound Design</a>
            </li>
            <li> <a href="<?= $site_url; ?>/categories/personal-growth/fashion-amp-style" class="left_cat_item">Fashion
                & Style</a> </li>
            <li> <a href="<?= $site_url; ?>/categories/ai-services/ai-for-businesses" class="left_cat_item">AI for
                Businesses</a> </li>
            <li> <a href="<?= $site_url; ?>/categories/programming-tech/Game-Development" class="left_cat_item">Game
                Development</a> </li>
            <li> <a href="<?= $site_url; ?>/categories/programming-tech/AI-Development" class="left_cat_item">AI
                Development</a>
          </ul>
      ...
      <div class="popular_service_div desktop-view-only">
        ...
        <div class="popular_service_div_60">
          ...
          <div class="popular_service_title">
            ...
            <a href="<?= $site_url; ?>/categories/programming-tech/Software-Development"
              class="margin-auto-link-paragraph">
        ...
        <div class="third_sectioninner_div_style">
          <div class="third_sectioninner_60">
            ...
            <div class="third_sectioninner_60paragraph">
              ...
              <div class="main-list-content-div-fth">
                <div class="image-icon-fth"><img src="images/quality_icon.png" alt="no image" width="100%"
                    class="m-auto">
                </div>
                <div class="content-img-fth">
                  <p>
                    Employers can efficiently explore these profiles to identify candidates who align with their project
                    needs
                    or job openings.
                  </p>
                </div>
              ...
              <div class="main-list-content-div-fth">
                <div class="image-icon-fth"><img src="images/payment_icon.png" alt="no image" width="100%"
                    class="m-auto">
                </div>
                <div class="content-img-fth">
                  <p>
              ...
              <div class="main-list-content-div-fth">
                <div class="image-icon-fth"><img src="images/fourth_icon.png" alt="no image" width="100%"
                    class="m-auto">
                </div>
                <div class="content-img-fth">
                  <p>
                    With detailed insights into each candidate's qualifications, "Hiremyprofile" aims to facilitate
                    successful
                    matches and productive collaborations in the hiring process.
                  </p>
                </div>
