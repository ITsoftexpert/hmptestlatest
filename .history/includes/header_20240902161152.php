...
<div class="sticky">
          ...
          <?php if (!isset($_SESSION["seller_user_name"])) { ?>
            ...
            <li class="sign-in-link mr-lg-0" id="style-join-border-red" style="display:flex">
              ...
              <span class="rampal_search"> <span id="ram_canvas_toggle" class="ram_canvas_toggle">
                <i id="scroll-icon" class="fa-solid fa-magnifying-glass"></i><!-- Unicode for search icon -->
                </span>
  ...
  color: #000; /* Adjust color as needed */
                ...
                <script>
                  ...
                  window.onscroll = function() {showIconOnScroll()};

function showIconOnScroll() {
  var scrollIcon = document.getElementById("scroll-icon");

  if (document.body.scrollTop > 20 || document.documentElement.scrollTop > 20) {
    scrollIcon.style.display = "block";  // Show the icon when scrolled
  } else {
    scrollIcon.style.display = "none";  // Hide the icon when not scrolled
  }
}
