            ...
            <li class="sign-in-link mr-lg-0" id="style-join-border-red" style="display:flex">
              ...
              <span class="rampal_search"> <span id="ram_canvas_toggle" class="ram_canvas_toggle">
                ...
                <style>
                  ...
                  .show-search {
                    display: block;
                    /* Show the search icon when class is added */
                  }
                ...
                <script>
                  ...
                  window.addEventListener('scroll', function () {
                    var searchIcon = document.querySelector('.rampal_search');
                    if (window.scrollY > 100) { // Change 100 to the scroll position at which you want to show the icon
