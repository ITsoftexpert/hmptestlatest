              ...
              <span class="rampal_search"> <span id="ram_canvas_toggle" class="ram_canvas_toggle">
                ...
                <script>
                  ...
                  window.addEventListener('scroll', function () {
                    ...
                    // Show the icon when the page is scrolled more than 100px
                    if (window.scrollY > 100) {
                      searchIcon.classList.add('block');  // Add class to show the icon
                    } else {
                      searchIcon.classList.remove('none');  // Remove class to hide the icon
                    }
                  });
