...
<body class="is-responsive">
	...
	<div class="container" style="margin-top: 200px !important;">
		...
		<div class="row only_desktop_view_card">
	...
	<div class="only_mobile_view_card">
		...
		$sel_orders_sm = $db->select("orders", array("seller_id" => $login_seller_id, "buyer_id" => $buyer_id), "DESC");
		...
		$sel_orders_sm = $db->query("SELECT * FROM orders WHERE seller_id = $login_seller_id AND buyer_id = $buyer_id ORDER BY order_date DESC LIMIT $initial_page, $limit");
		...
		<div class="pagination-new">
			<?php if ($page_number > 1): ?>
				<a href="?page=1&buyer_id=<?= $buyer_id; ?>" class="pagination-new-link">First</a>
				<a href="?page=<?= $page_number - 1; ?>&buyer_id=<?= $buyer_id; ?>" class="pagination-new-link">Prev</a>
			<?php endif; ?>
			...
			<?php for ($i = 1; $i <= $total_pages; $i++): ?>
				...
				<?php else: ?>
					<a href="?page=<?= $i; ?>&buyer_id=<?= $buyer_id; ?>" class="pagination-new-link"><?= $i; ?></a>
				<?php endif; ?>
			<?php endfor; ?>

			<?php if ($page_number < $total_pages): ?>
				<a href="?page=<?= $page_number + 1; ?>&buyer_id=<?= $buyer_id; ?>" class="pagination-new-link">Next</a>
				<a href="?page=<?= $total_pages; ?>&buyer_id=<?= $buyer_id; ?>" class="pagination-new-link">Last</a>
			<?php endif; ?>
		</div>
