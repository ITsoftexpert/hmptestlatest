      ...
      <div class="col-md-12">
        <div class="row">
          <div class="col-md-8 offset-md-1">
            <h1 class="mb-4"> Order Managements </h1>
          </div>
          <div class="col-md-3">
          ...
          <div class="row">
            <div class="col-md-10 offset-md-1">
              ...
              <div class="proposal_reviews mt-5">
                <?php
                if ($order_status == "completed" && $login_seller_id == $buyer_id) {
                ?>
                  ...
                  <div id="forreview" style="display: none;">
                    <?php
                  ...
                  <div id="forcontinue" style="display: none;">
                    <?php include("milestone_after.php"); ?>
                  </div>
                <?php } elseif ($order_status == "completed" && $login_seller_id == $seller_id) {
                  if ($count_buyer_reviews == 1 and $login_seller_id == $seller_id) {
                    include("orderIncludes/orderReviews.php");
                  }
                }
                ?>
