<div class="box" align="center">
  <div class="container" style="max-width: 632px;margin: 0 auto;">
    <div class="row bg-white o_sans" style="padding-top: 0px; padding-bottom: 35px;">
      ...
      <h2 class="o_heading">Delivery Extension Request Accepted</h2>

      <p class="text-muted">
        Hello, <?= $data['user_name']; ?>. Your request for an extension on the delivery of the order has been <strong><?= $data['extend_result']; ?></strong>.
      </p>
