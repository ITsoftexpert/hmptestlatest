...
<div class="card border-success mb-3">
  <div class="card-header bg-success box-shadow-freelancer-sbh">
    <h3 class="<?= ($lang_dir == "right" ? 'float-right' : 'float-left') ?> h5 text-white">
      ...
      while ($row_cats = $get_cats->fetch()) {
        ...
        <li class="nav-item">
          <span class="nav-link <?php if ($cat_id == @$_SESSION['cat_id'] || $cat_id == @$child_parent_id) {
            ...
            <a class="text-success_rampal2"> <?= $cat_title; ?> <a class="h5 text-success_rampal float-right">
                <i class="fa fa-arrow-circle-down text-success_rampal2"></i>
              </a></a>
          </span>
          <ul id="cat_<?= $cat_id; ?>" class="collapse pl-1 <?php if ($cat_id == @$_SESSION['cat_id'] || $cat_id == @$child_parent_id) {
            ...
            while ($row_child_cat = $get_child_cat->fetch()) {
              ...
              if (!empty($child_title)) {
                ?>
                <li>
                  <a class="nav-link text-success_rampal2 <?php if ($child_id == @$_SESSION['cat_child_id']) {
                    echo "active";
                  } ?>"
...
<script>
  document.addEventListener('DOMContentLoaded', function () {
    const links = document.querySelectorAll('.text-success_rampal2');
...
<div class="card border-success mb-3">
  <div class="card-header bg-success box-shadow-freelancer-sbh">
    <h3 class="<?= ($lang_dir == "right" ? 'float-right' : 'float-left') ?> text-white h5">
