			...
			swal({
			  ...
			  customClass: 'animated tada'
					...
					if ($select_seller) {
						...
						$update_seller = $db->update("sellers", array("seller_status" => 'online', "acc_status" => 'active', "seller_ip" => $ip), array("seller_id" => $row_seller->seller_id, "seller_pass" => $hashed_password));
