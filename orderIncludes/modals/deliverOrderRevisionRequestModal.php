        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            if (isset($_POST['submit_delivered'])) {
              ...
              if ($order_status == "progress" or $order_status == "Extend Time Accepted" or $order_status == "Extend Time Declined" or $order_status == "revision requested" or $order_status == "delivered") {
                ...
                if (!in_array($file_extension, $allowed) & !empty($d_file)) {
                  ...
                  if ($insert_delivered_message) {
                    ...
                    $db->update("milestone", array("milestone_status" => "delivered", "order_id" => $order_id), array("milestone_id" => $milestone_id));
          ...
          if (isset($_POST['submit_revison'])) {
            ...
            if (!in_array($file_extension, $allowed) & !empty($revison_file)) {
              ...
              if ($insert_revision_message) {
                ...
                $db->update("milestone", array("milestone_status" => "revision requested", "order_id" => $order_id), array("milestone_id" => $milestone_id));
