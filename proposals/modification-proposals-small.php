<div class="order-card">
    ...
    ?>
                ...
                <div class="order-status">
                    ...
                    <div class="custom-dropdown">
                        ...
                        <div class="custom-dropdown-content">
                            <a href="<?= $site_url; ?>/proposals/submit_approval?proposal_id=<?= $proposal_id; ?>"> Submit For Approval </a>
        ...
        ?>
        <div class="order-card table-danger box-shadow-bg-color">
            <center>
    ...
    <?php } ?>
    <nav id="pagination-proposals-modification-small" aria-label="modification proposals navigation">
