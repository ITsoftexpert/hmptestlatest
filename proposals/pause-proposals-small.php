<div class="order-card">
    ...
    if ($totalDRows > 0) {
        ...
        while ($row_proposals = $select_proposals->fetch()) {
            ...
            if ($proposal_status == "admin_pause") {
                $onclick = 'onclick="return confirm(\'Admin has paused this proposal.\')"';
            } else {
                $onclick = "";
            }
    ?>
            ...
            <div class="order-status">
                ...
                <div class="custom-dropdown">
                    ...
                    <div class="custom-dropdown-content">
                        ...
                        <a href="<?= $site_url; ?>/proposals/activate_proposal?proposal_id=<?= $proposal_id; ?>" class="dropdown-item" <?= $onclick; ?>>Activate</a>
    ...
    <nav id="pagination-proposals-pause" aria-label="Paused proposals navigation">
