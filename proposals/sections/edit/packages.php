...
<script>
  ...
  basicTextAreaElement.addEventListener("input", (event) => {
  ...
  standardTextAreaElement.addEventListener("input", (event) => {
  ...
  advancedTextAreaElement.addEventListener("input", (event) => {
