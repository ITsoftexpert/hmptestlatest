  ...
  <div class="row">
    <div class="col-lg-8 col-md-7 mb-3 p-4 box-shadow-outset">
      ...
      <style>
        ...
        .paragrapgh_font_size_clone {
          font-size: 18px;
          text-align: center;
        }

        .edit_proposal_cloning_btn {
          padding: 10px 20px;
          margin: 1rem auto;
          border-radius: 5px;
      ...
      <!-- clone proposal edit popup -->

<?php 
if($clone_status == "yes"){ ?>

      <div class="clone_propo_edit_popup_outer">
        <div class="clone_propo_edit_popup">
          <div class="w-100 d-flex">
            <img src="<?= $site_url; ?>/images/edit-icon-symbol-design-illustration-vector.jpg" class="m-auto" alt="edit-icon-symbol-design-illustration-vector" width="20%">
          </div>
          <h2 class="text-center mb-3 mt-2">Edit Cloned Proposal</h2> 
          <p class="paragrapgh_font_size_clone">This is a cloned version of your proposal. Please review and make necessary edits.</p>
          <a href="../edit_proposal.php?proposal_id=<?= $proposal_id; ?>" class="w-100 d-flex"><button class="edit_proposal_cloning_btn">Edit Proposal</button></a>
        </div>
      </div>
 <?php } ?>
      <!-- clone proposal edit popup -->
